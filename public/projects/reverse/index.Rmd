...
knitr::include_graphics(here::here("yield_curve_parable.jpg"), error = FALSE)
```
...
knitr::include_graphics(here::here("yield_curve_challenge.png"), error = FALSE)
```
...
knitr::include_graphics(here::here("yield_curve1.png"), error = FALSE)
```
...
knitr::include_graphics(here::here("yield_curve2.png"), error = FALSE)
```
...
knitr::include_graphics(here::here("yield_curve3.png"), error = FALSE)
```
...
> Our one-sentence insight

In this graph, it seems that every recession since 1960s has been preceded by a yield curve inversion. But yield curve inversion doesn't always precede a recession. For instance, in the second half of 1966 and 2019 the yield curve inverted but a recession didn’t closely follow. Since 1999, short-term yield was higher than longer term debt in 2000.8-2000.12, 2006.8-2007.4, 2019.6-2019.9 and 2020.2.
